...
var appTarget = document.getElementById('scratch');
appTarget.className = _index_css__WEBPACK_IMPORTED_MODULE_10___default.a.app; // document.body.appendChild(appTarget);
